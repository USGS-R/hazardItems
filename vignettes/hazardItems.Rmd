...
When a storm is no longer 'Active' the user should return to the mediation page, and uncheck the active storm checkbox. They can alter its location from the tree, to either orphan the record or move it under another card.
